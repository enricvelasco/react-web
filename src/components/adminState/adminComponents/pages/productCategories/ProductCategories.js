...
export class ProductCategories extends Component{
  ...
  _loadStateMode=()=>{
    switch (this.state.stateMode) {
      case "list":
          return(<ProductCategoriesList title={this.title} subtitle={this.subtitle} urlMapping={this.props.urlMapping} filter={this.props.filter} onReturnEdit={this._onReturnEdit} onReturnNew={this._onReturnNew}/>)
        break;
      case "new":
          var formulary
          ...
          //}else{
            formulary=<ProductCategoriesFormulary onCancel={this._onCancel} onSave={this._onSave}/>
          //}
          return formulary
        break;
      case "edit":
          ...
          //  formulary = <UsersFormularyAssociation onCancel={this._onCancel} onSave={this._onSave} idAssociation={this.props.associationId}/>
          //}else{
            formulary =< ProductCategoriesFormulary urlMapping={this.props.urlMapping} idUrl={this.idToEdit} onCancel={this._onCancel} onSave={this._onUpdate}/>
          //}
          return formulary
        break;
      default:
