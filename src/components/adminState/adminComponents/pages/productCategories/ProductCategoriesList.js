...
export class ProductCategoriesList extends Component{
  constructor(props){
    super(props)
  ...
  componentWillUpdate(props,state){
    console.log("ProductCategoriesList LIST-componentWillUpdate", props, state);
    //this._loadData();
  }
  ...
  _loadData(coll){
    ...
    coll.get().then((querySnapshot) => {
        ...
        this.setState({loading:false})
				console.log("RESULTADO ProductCategoriesList", this.rows);
		}).catch((err)=>{
      console.log(err);
    });
  }
