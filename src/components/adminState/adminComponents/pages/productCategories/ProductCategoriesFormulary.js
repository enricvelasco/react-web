...
export class ProductCategoriesFormulary extends Component{
  ...
  constructor(props){
    ...
    console.log("ProductCategoriesFormulary FORMULARY !!!!! ", props);
    if(props.idUrl != null){
  ...
  _paramsSection0=()=>{
      return(
        <div>
          ...
          <Select inputTitle="Categoría Padre" resourceName="fatherCategory" required={false} url={"productCategories"} showFields={["code", "name"]} onResults={this._respInput} filter={["isFather","==",true]} value={this.state.objectToSave.fatherCategory}/>
