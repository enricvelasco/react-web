...
export class InitialList extends Component{
  constructor(props){
    super(props)
  ...
  componentWillUpdate(props,state){
    console.log("INITIAL LIST-componentWillUpdate", props, state);
    //this._loadData();
  }

  _moutColumns(){
    this.columns = [
      { key: 'codigoLink', name: 'Camp0', formatter: <LinkColumn nameLinkColumn="code" onResults={this._respuestaCampoLink}/>},
      { key: 'camp1', name: 'Camp1'},
      { key: 'camp2', name: 'Camp2' }];
  }
