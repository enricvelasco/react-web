...
export class StoreCategoriesList extends Component{
  constructor(props){
    super(props)
  ...
  componentWillUpdate(props,state){
    console.log("StoreCategoriesList LIST-componentWillUpdate", props, state);
    //this._loadData();
  }
  ...
  _loadData(coll){
    ...
    coll.get().then((querySnapshot) => {
        ...
        this.setState({loading:false})
				console.log("RESULTADO StoreCategoriesList", this.rows);
		}).catch((err)=>{
      console.log(err);
    });
  }
